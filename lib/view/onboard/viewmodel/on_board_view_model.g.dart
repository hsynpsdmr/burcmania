...
mixin _$OnBoardViewModel on OnBoardViewModelBase, Store {
  late final _$currentIndexAtom =
      Atom(name: 'OnBoardViewModelBase.currentIndex', context: context);
  ...
  late final _$OnBoardViewModelBaseActionController =
      ActionController(name: 'OnBoardViewModelBase', context: context);

  @override
  void changeCurrentIndex(int value) {
    final _$actionInfo = _$OnBoardViewModelBaseActionController.startAction(
        name: 'OnBoardViewModelBase.changeCurrentIndex');
    try {
